...
import { DEFAULT_ACCESS_TOKEN_EXPIRE, DEFAULT_ACTIVATION_TOKEN_EXPIRE, DEFAULT_REFRESH_TOKEN_EXPIRE } from "./default.config";
...
let {
    ...
    SMTP_PASSWORD
        ...
        ACTIVATION_TOKEN_EXPIRE: string;
...
export const CONFIG_PORTS = {
    ...
    ACTIVATION_TOKEN_EXPIRE: getNumericalValue(ACTIVATION_TOKEN_EXPIRE, DEFAULT_ACTIVATION_TOKEN_EXPIRE),
